...
export class Boid {
  ...
  constructor(speedLimit: number, perceptionRadius: number) {
    this.position = getRandomPositionWithinScreen(800, 800, 0, 0);
    ...
    this.color = "white";
    this.desiredRandomPosition = getRandomPositionWithinScreen(800, 800, 0, 0);
  }
  ...
  update(neighbors?: Boid[]): void {
    ...
    this.getVelocity().clampLength(0, 3);
