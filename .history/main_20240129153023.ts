...
const sliderPerceptionRadiusSlider = document.getElementById(
  "perceptionRadiusSlider"
);

sliderPerceptionRadiusSlider!.oninput = function () {
  const value = sliderPerceptionRadiusSlider!.value;
  console.log(value); // Log or use the value as needed
};
