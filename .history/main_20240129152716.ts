...
function updatePerceptionRadius(value: string): void {}

// Attach the event listener to the input element
const perceptionRadiusInput = document.getElementById(
  "perceptionRadiusInput"
) as HTMLInputElement;

if (perceptionRadiusInput) {
  perceptionRadiusInput.addEventListener("input", function () {
    updatePerceptionRadius(perceptionRadiusInput.value);
  });
}
function animate() {
