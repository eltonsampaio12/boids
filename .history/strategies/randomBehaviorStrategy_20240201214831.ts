  ...
  implements IBoidBehaviorStrategy
{
  ...
  update(boid: Boid, neighbors?: Boid[]): void {
    ...
    //pick a new location, once you get to your destination.
    if (distance <= this.getStoppingDistance() * this.getStoppingDistance()) {
      boid.setDesiredRandomPosition(
        getRandomPositionWithinScreen(300, 300, 0, 0)
      );
    }
  }
}
